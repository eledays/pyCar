...
Events.on(engine, 'beforeUpdate', () => {
    ...
    if (window.carControl) {
        speed += (
            ...
            window.carControl.engine.started *
            window.carControl.gearbox.gear
        );
        speed = Math.min(speed, maxSpeed);

        // if (window.carControl.engine.started && window.carControl.engine.power > 0) {
        //     speed += acceleration * window.carControl.engine.power * window.carControl.engine.started;
        //     speed = Math.min(speed, maxSpeed);
        // }
